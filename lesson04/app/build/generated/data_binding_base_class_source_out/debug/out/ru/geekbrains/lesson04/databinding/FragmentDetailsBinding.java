...
public final class FragmentDetailsBinding implements ViewBinding {
  ...
  private FragmentDetailsBinding(@NonNull FrameLayout rootView, @NonNull TextView cityCoordinates,
  ...
  public static FragmentDetailsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDetailsBinding((FrameLayout) rootView, cityCoordinates, cityName,
